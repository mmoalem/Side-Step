...
> **Status:** v1.0.1 -- Stable enough for daily use. Some features are still experimental. This is beta software being maintained by one person only; if you encounter an issue, please let me know in the issues tab.
